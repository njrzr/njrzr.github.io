...
const hoverDescription = (skillType: string = ''): void => {
  ...
  if (skillType != 'leave') skill.value = skillType
}
...
<template>
  <div class="relative w-full h-full bg-[url('/images/background-skills-blurred.jpg')] bg-no-repeat bg-cover bg-center">
    ...
    <div v-else class="relative md:flex p-2 pb-16 md:p-0 md:pb-0 md:justify-center md:items-center w-full h-full overflow-y-scroll md:overflow-hidden">
      <div @mouseenter="hoverDescription('html')" @mouseleave="hoverDescription('leave')" class="absolute hidden md:flex justify-center items-center w-30 h-24 scale-200 bg-main hexagon-calc cursor-pointer translate-calc">
        <img class="relative w-14 h-14 object-cover object-center" src="/assets/svg/html5.svg" alt="HTML5 Icon">
      </div>

      <div class="hidden md:block translate-x-[24vw] -translate-y-[18vh]">
        <div @mouseenter="hoverDescription('css')" @mouseleave="hoverDescription('leave')" class="absolute flex justify-center items-center w-30 h-24 scale-200 bg-main hexagon-calc cursor-pointer translate-calc">
          <img class="relative w-14 h-14 object-cover object-center" src="/assets/svg/css.svg" alt="CSS Icon">
        </div>
      </div>

      <div class="hidden md:block -translate-x-[26vw] -translate-y-[28vh]">
        <div @mouseenter="hoverDescription('javascript')" @mouseleave="hoverDescription('leave')" class="absolute flex justify-center items-center w-30 h-24 scale-200 bg-main hexagon-calc cursor-pointer translate-calc">
          <img class="relative w-14 h-14 object-cover object-center" src="/assets/svg/javascript.svg" alt="Javscript Icon">
        </div>
      </div>

      <div class="hidden md:block -translate-x-[30vw] translate-y-[15vh]">
        <div @mouseenter="hoverDescription('php')" @mouseleave="hoverDescription('leave')" class="absolute flex justify-center items-center w-30 h-24 scale-200 bg-main hexagon-calc cursor-pointer translate-calc">
          <img class="relative w-14 h-14 object-cover object-center" src="/assets/svg/php.svg" alt="PHP Icon">
        </div>
      </div>

      <div class="hidden md:block translate-x-[26vw] translate-y-[25vh]">
        <div @mouseenter="hoverDescription('sql')" @mouseleave="hoverDescription('leave')" class="absolute flex justify-center items-center w-30 h-24 scale-200 bg-main hexagon-calc cursor-pointer translate-calc">
          <img class="relative w-14 h-14 object-cover object-center" src="/assets/svg/mariadb.svg" alt="MariaDB Icon">
        </div>
      </div>

      <div class="hidden md:block -translate-x-[20vh] translate-y-[40vh]">
        <div @mouseenter="hoverDescription('bash')" @mouseleave="hoverDescription('leave')" class="absolute flex justify-center items-center w-30 h-24 scale-200 bg-main hexagon-calc cursor-pointer translate-calc">
          <img class="relative w-14 h-14 object-cover object-center" src="/assets/svg/gnometerminal.svg" alt="Terminal Icon">
        </div>
      </div>

      <div class="hidden md:block translate-x-[70vw] translate-y-[50vh]">
        <div @mouseenter="hoverDescription('others')" @mouseleave="hoverDescription('leave')" class="absolute flex justify-center items-center w-30 h-24 scale-200 bg-main hexagon-calc cursor-pointer translate-calc">
